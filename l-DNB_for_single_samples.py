...
def parallel_procedure(stage,normal,disease,title,ref,network,sd_mean,j):
...
if __name__=="__main__":
    ...
    for stage in stages:
        ...
        for j in range(len(title)):
            pool.apply_async(parallel_procedure,(stage,normal,disease,title,ref,network,sd_mean,j,))
    pool.close()
    pool.join()
